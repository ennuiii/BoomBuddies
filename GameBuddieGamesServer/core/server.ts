  ...
  private setupGameNamespace(plugin: GamePlugin): void {
    ...
    namespace.on('connection', (socket: Socket) => {
      ...
      socket.on('room:create', async (data: {
        ...
        console.log(`[STREAMER DEBUG] Room ${room.code} created with streamerMode=${room.isStreamerMode}, hideRoomCode=${room.hideRoomCode} (from data: streamerMode=${data.streamerMode}, hideRoomCode=${data.hideRoomCode})`);
      ...
      socket.on('room:join', async (data: {
        ...
        console.log(`[STREAMER DEBUG] Player joining room ${room.code}, room.isStreamerMode=${room.isStreamerMode}, room.hideRoomCode=${room.hideRoomCode}`);
